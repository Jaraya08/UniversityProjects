...
angular.autoValidate.errorMessages['default'] = {
  defaultMsg: 'Por favor agregue un mensaje de error para {0}',
   email: 'Por favor, introduzca una dirección de correo electrónico válida',
   minlength: 'Por favor ingrese al menos {0} caracteres',
   maxlength: 'Ha ingresado más del máximo de {0} caracteres',
   min: 'Por favor ingrese el número mínimo de {0}',
   max: 'Por favor ingrese el número máximo de {0}',
   required: 'Este campo es requerido',
   date: 'Por favor, introduzca una fecha válida',
   pattern: 'Asegúrese de que la información ingresada se adhiere a este patrón {0}',
   number: 'Por favor, introduzca un número válido',
   url: 'Introduzca una URL válida en el formato de http (s): //www.google.com'
};
